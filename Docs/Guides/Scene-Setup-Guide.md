...
> **Consolidated from:** SCENE_SETUP_QUICKSTART.md, SCENE_SETUP_GUIDE.md
...
- `Equipment-System.md` - Equipment system architecture
- `Skill-Test-Environment.md` - Detailed skill testing guide
- `Ranged-Attack-System.md` - Ranged attack implementation
